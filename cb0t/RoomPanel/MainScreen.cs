                        ...
                        if (!String.IsNullOrEmpty(uri.Host))
                        {
                            switch (uri.Host)
                            {
                                case "hashlink.link":
                                    ...
                                    if (str2.StartsWith("http://hashlink.link/?h="))
                                    {
                                        str2 = str2.Substring(24);
                                        DecryptedHashlink hashlink = Hashlink.DecodeHashlink(str2);
                    ...
                    case (char)12953:
                        ...
                        if (can_emoticon)
                        {
                            ...
                            if (emoji_item != null)
                            {
                                if (emote_count++ < 8)
                                {
                                    html.Append("<img style=\"height: 24px; margin-bottom: -1px;\" alt=\"\" src=\"http://emotic.emoji/" + emoji_item.FileName + "\" />");
