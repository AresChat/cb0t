...
namespace cb0t
{
    public partial class BrowseLeftContainer : UserControl
    {
        ...
        public void UpdateTemplate()
        {
            ...
            this.treeView1.Nodes[1].Text = this.treeView1.Nodes[1].Text.Replace("Audio", StringTemplate.Get(STType.BrowseTab, 2));
            this.treeView1.Nodes[2].Text = this.treeView1.Nodes[2].Text.Replace("Image", StringTemplate.Get(STType.BrowseTab, 3));
            this.treeView1.Nodes[3].Text = this.treeView1.Nodes[3].Text.Replace("Video", StringTemplate.Get(STType.BrowseTab, 4));
            this.treeView1.Nodes[4].Text = this.treeView1.Nodes[4].Text.Replace("Document", StringTemplate.Get(STType.BrowseTab, 5));
            this.treeView1.Nodes[5].Text = this.treeView1.Nodes[5].Text.Replace("Software", StringTemplate.Get(STType.BrowseTab, 6));
            this.treeView1.Nodes[6].Text = this.treeView1.Nodes[6].Text.Replace("Other", StringTemplate.Get(STType.BrowseTab, 7));
        }
